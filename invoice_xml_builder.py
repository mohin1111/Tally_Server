"""Build Tally-compatible XML for invoice creation.
...
def build_invoice_xml(payload: CreateInvoicePayload) -> str:
    """Build complete Tally XML envelope for invoice vouchers."""
